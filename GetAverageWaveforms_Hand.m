...
%   interest, e.g. 190517GM_Hand. The script specifically looks for       %
...
%                                                                         %
%   To run the same analysis on the lip data, run                         %
...
muscle = '*_Hand';
testMuscle = 1;                                                        % audioVisual takes A or V for audio or visual, and converts it to 1 or 2 respectively
    ...
    for y = 1:length(info)
        ...
        if strcmp(condition, '1') == 1
            if strcmp(timepoint, '50') == 1
                a50 = [a50 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '150') == 1
                a150 = [a150 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '250') == 1
                a250 = [a250 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '350') == 1
                a350 = [a350 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '450') == 1
                a450 = [a450 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '550') == 1
                a550 = [a550 num2cell(Ch1.values)];                
            end
        elseif strcmp(condition, '2') == 1
            if strcmp(timepoint, '50') == 1
                ai50 = [ai50 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '150') == 1
                ai150 = [ai150 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '250') == 1
                ai250 = [ai250 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '350') == 1
                ai350 = [ai350 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '450') == 1
                ai450 = [ai450 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '550') == 1
                ai550 = [ai550 num2cell(Ch1.values)];                
            end
        elseif strcmp(condition, '3') == 1
            if strcmp(timepoint, '50') == 1
                dn50 = [dn50 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '150') == 1
                dn150 = [dn150 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '250') == 1
                dn250 = [dn250 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '350') == 1
                dn350 = [dn350 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '450') == 1
                dn450 = [dn450 num2cell(Ch1.values)];
            elseif strcmp(timepoint, '550') == 1
                dn550 = [dn550 num2cell(Ch1.values)];                
            end
        end
        clear Ch3
...
%ai vs h vs dn
figure(19)
boundedline(times_msec(time_1:time_2), grandmean_a(time_1:time_2), grandsem_a(time_1:time_2),'-b',...
            times_msec(time_1:time_2), grandmean_ai(time_1:time_2), grandsem_ai(time_1:time_2),'-r',...
            times_msec(time_1:time_2), grandmean_dn(time_1:time_2), grandsem_dn(time_1:time_2),'-y','alpha')
